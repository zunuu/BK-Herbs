    ...
    return (
        <div className='about'>
            ...
            <section>
                ...
                <div className='bg-primary bg-opacity-25 rounded-3 d-flex row m-2 p-5 justify-content-center align-items-center'>
                    <span className='col-xl-5 col-md-12 col-sm-12 col-12 justify-content-center mx-auto align-items-center   '>

                        <img className='companyLogo my-2' src={companyLogo} alt="" />

                    </span>
                    <p className='col-xl-5 col-md-12 col-sm-12 col-12 aboutcontent bg-success bg-opacity-25 p-5 '>
